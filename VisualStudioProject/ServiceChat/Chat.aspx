<%@ Page Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeBehind="Chat.aspx.cs" Inherits="ServiceChat.Chat" ValidateRequest="false"%>
        ...
        <div class="col s12 m9 message-list" id="Messages">
            <ul>
                <% foreach (var m in MessageList) { %>
                    <li class="row">
                        <span class="col s12 m3 message-author"><%= HttpUtility.HtmlEncode(Account.Get(m.Username).DisplayName) %></span>
